...
// this function removes the landingpage, and fills in the flag and choices on the page, based on the getCurrentQuestion() function declared in the quiz controller
function showQuestion() {
    ...
    if(multipleChoiceQuiz.finished()) {
        ...
        // grabs the id 'flag' declared in the html file and adds the image path for the flag from the question object
        document.getElementById('flag').src = multipleChoiceQuiz.getCurrentQuestion().flag;
        // fills in the buttons with the choices from the question object
...
// this registers which botton presses and calls the guessInput function which is declared in the quiz controller
...
// this shows the progress in the quiz. showing the current question number, total amount of questions, the score and the amount wrong answers.
...
// this function creates a result screen after the quiz has ended, shows the score and adds a replay button
...
// array with the questions, contain a path the flag image source, 4 different choice and 1 correct answer.
